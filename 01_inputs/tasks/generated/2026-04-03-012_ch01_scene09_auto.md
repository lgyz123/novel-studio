# task_id
2026-04-03-012_ch01_scene09_auto

# goal
写出《无住人间》第一章第九个短场景：孟浮灯在确认被监视后，决定采取更隐蔽的调查方式，利用收尸工作的日常性，在乱葬岗处理尸体时，尝试从尸体或环境中寻找与“阿绣”相关的细微线索，但遭遇新的阻力（如线索被清理、环境异常），从而将调查从主动观察转向被动发现，并引发一次微小的后果（如确认风险升级、线索中断）。本场重点：引发后果、提高风险、扩展世界信息。
...
主角必须执行一个微决策，如检查尸体或环境后，决定改变后续行动（如暂缓调查、更隐蔽地藏匿物品）。
...
- 允许：乱葬岗环境 / 尸体处理细节 / 土/坑痕迹 / 风/气味变化
- 禁止：麻绳 / 红绳 / 平安符 / 在码头 / 孟浮灯把绳 / 什么 / 着一把短刀 / 麻袋 / 他把绳
- 仅在承担新功能时允许：那截红绳 / 出个扁木盒 / 这绳 / 他捏着绳 / 股混杂的气味
  ...
  "revelation_updates": [
    {
      ...
      "content": "乱葬岗环境有异常变化，如土被翻动、物品位置移动"
    },
    {
      "type": "suspected_added",
      "content": "尸体或环境线索被主动清理，调查受阻"
    }
  ],
  "artifact_state_hints": [
    {
      "item_id": "artifact_乱葬岗痕迹",
      "label": "乱葬岗痕迹",
      "holder": "环境",
      "location": "乱葬岗",
      "visibility": "visible",
      "significance_level": "medium",
      "last_changed_scene": "ch01_scene09"
    }
  ],
  "progress_updates": [
    {
